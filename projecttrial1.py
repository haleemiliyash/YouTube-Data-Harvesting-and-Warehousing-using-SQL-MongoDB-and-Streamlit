...
def channel_DT(c_id):
    ...
    st.sidebar.success("MongoDB Stored Successfully")
    return data
...
channel_id=[]
collection=db['channel_dt']
for ch_info in collection.find({},{'_id':0,'channel_data':1}):
    channel_name.append(ch_info['channel_data']['channel_name'])
    channel_id.append(ch_info['channel_data']['channel_ID'])
c_name=st.sidebar.selectbox('Select the channel ID',channel_name)
#==================================================================DATA TRANSFER TO SQL DATABASE==========================================================================================================================================================================================================#
if c_name and st.sidebar.button("Migrate to SQL"):
    try:
    ...
    try:
        ...
        data=collection1.find_one({'channel_data.channel_name':c_name})
        x=data['channel_data']
        ...
        data2=collection2.find_one({'channel_data.channel_name':c_name})
        y=data2['video_data']
        for i in y:
        ...
        data3=collection3.find_one({'channel_data.channel_name':c_name})
        ...
        mydb.commit()   
        st.sidebar.success("SQL Migration completed")
    except:
